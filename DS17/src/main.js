...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Define scenes as functions that return classes
  ...
  const GameScene = class extends Phaser.Scene {
    ...
    createOrders() {
      ...
      orderTypes.forEach((order, i) => {
        ...
        // Click to complete (simplified for now)
    ...
    drawCard() {
      ...
      const card = this.add.sprite(x, y, cardType + '_full').setScale(0.7);
      this.updateCardCount();
    }
