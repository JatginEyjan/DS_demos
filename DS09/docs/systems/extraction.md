...
4. **难度曲线调整**：陷阱密度/伤害/精神力层数递增

#### 🟡 P1 - 增强体验
5. **撤离的叙事代价**：成功撤离但留下精神创伤（叙事描述）
6. **层间关联**：撤离时是否可以保留某些"记忆"影响下一层？
7. **紧急撤离**：极低理智时是否可以"狼狈逃跑"（损失部分资源）？

#### 🟢 P2 - 探索性
8. **主动挑战**：玩家可以选择增加难度换取更高收益？
9. **撤离倒计时**：达标后倒计时，强迫快速决策？
