...
#### 🔴 P0 - 影响核心体验
1. **幻觉的叙事支撑**：幻觉时应该有专属的剧情文本
2. **👁️提示分级**：不同等级的剧情房应该有不同强度的提示
3. **幻觉渐进性**：理智越低，幻觉影响越严重

#### 🟡 P1 - 增强体验
4. **威胁等级动态调整**：深层地牢是否应该更危险？
5. **幻觉后遗症**：理智恢复后，短期内信息是否应该有延迟？

#### 🟢 P2 - 探索性
6. **自定义幻觉**：是否可以有"主动进入幻觉"换取某种能力？
7. **威胁底色的视觉多样性**：同一等级是否可以有细微变化？
