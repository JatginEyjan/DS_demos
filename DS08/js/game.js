                ...
                main: [
                    {
                        ...
                        goodOutcome: { text: '你找到了一盏还能使用的煤油灯，照亮了前方的道路', reward: '理智+10，获得照明工具', sanity: 10 },
                ...
                main: [
                    {
                        ...
                        goodOutcome: { text: '你在铁盒底层发现了一枚铜钥匙，上面刻着"宝库"二字', reward: '理智+10，获得钥匙道具', sanity: 10 },
                    ...
                    },
                    {
                        ...
                        goodOutcome: { text: '你发现了一条隐蔽的下行阶梯，是古代蛇人修建的', reward: '理智+5，安全通过', sanity: 5 },
                ...
                main: [
                    {
                        ...
                        goodOutcome: { text: '你发现了控制水晶的机关，停止了哀泣，头颅们闭上了眼睛', reward: '理智+20，精神净化', sanity: 20 },
                    ...
                    },
                    {
                        ...
                        goodOutcome: { text: '你发现了坑壁上的攀爬点，安全降入并成功找到出口', reward: '理智+5，发现通道', sanity: 5 },
                ...
                main: [
                    {
                        ...
                        goodOutcome: { text: '退化人对你产生好奇，允许你安全通过', reward: '理智+10，避免战斗', sanity: 10 },
